...
function Profile() {
  ...
  return (
    <div className="profile-container flex justify-center items-center h-screen bg-white">
      <div className="profile-card-container flex flex-col md:flex-row max-w-screen-lg space-y-4 md:space-y-0">
        {/* Sección de datos del perfil y edición */}
        <div className="profile-card bg-white p-6 rounded-lg shadow-lg flex-grow-1">
        ...
        {/* Sección de tabla de usuarios registrados (solo visible para administradores) */}
        {isAdmin && (
          <div className="admin-section bg-white p-6 rounded-lg shadow-lg flex-grow-1">
